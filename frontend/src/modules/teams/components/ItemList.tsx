...
export const TeamItemList = ({ team, onDelete }: TeamItemListProps) => {
  ...
  const formatFoundationDate = (foundation: [number, number, number] | undefined): string => {
  ...
  return (
    <TableRow key={team.id}>
      ...
      <TableCell className="text-start">{formatFoundationDate(team.foundation)}</TableCell>
      <TableCell className="text-start">{formatCreatedDate(team.createdAt)}</TableCell>
      <TableCell>
