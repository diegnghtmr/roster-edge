...
export const StaffRoleItemList = ({
  staffRole,
  onDelete,
}: StaffRoleItemListProps) => {
  // Format created date
  ...
  return (
    <TableRow key={staffRole.id}>
      ...
      <TableCell className="text-start">
        <Badge variant={staffRole.active ? "default" : "secondary"}>
          {staffRole.active ? "Activo" : "Inactivo"}
        </Badge>
      </TableCell>
      <TableCell className="text-start">
        {formatCreatedDate(staffRole.createdAt)}
      </TableCell>
      <TableCell>
