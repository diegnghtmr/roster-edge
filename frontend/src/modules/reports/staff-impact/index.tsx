      ...
      <div className="bg-white w-full shadow-md rounded-lg min-h-screen p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <StatCard
            ...
            value={
              impact?.ratioWinRateCorrelation ? impact.ratioWinRateCorrelation.toFixed(3) : 'N/A'
            }
          ...
          <StatCard
            ...
            value={
              impact?.ratioPointsCorrelation ? impact.ratioPointsCorrelation.toFixed(3) : 'N/A'
            }
            subtitle="coeficiente de correlación"
            ...
            <Card>
              ...
              <CardContent>
                <BarChartComponent
                  data={chartData}
                  xKey="name"
                  bars={[{ key: 'ratio', name: 'Ratio Staff/Jugador', color: '#f97316' }]}
                  yAxisLabel="Ratio"
                  height={400}
                />
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <BarChartComponent
                  data={chartData}
                  xKey="name"
                  bars={[{ key: 'winRate', name: '% Victorias', color: '#10b981' }]}
