...
export const NotificationItemList: React.FC<NotificationItemListProps> = ({
  notification,
}) => {
  ...
  return (
    <tr className="border-b hover:bg-gray-50 transition-colors duration-200">
      ...
      <td className="px-6 py-4 text-sm">
        {getRelatedClubsText(notification?.relatedClubEvents)}
      </td>
      <td className="px-6 py-4 text-sm">
        {getRelatedEventsText(notification?.relatedClubEvents)}
      </td>
    </tr>
  );
};
