  ...
  const commonIssues = [
    {
      ...
      severity: 'high',
      solution:
        'Verifica tu conexión a internet y asegúrate de usar las credenciales correctas. Si el problema persiste, restablece tu contraseña.',
      status: 'resolved',
    },
    {
      id: 2,
      ...
      severity: 'medium',
      solution:
        'Revisa que todos los campos obligatorios estén completos. Verifica que el nombre del equipo no esté duplicado.',
      status: 'resolved',
    },
    {
      id: 3,
      ...
      severity: 'low',
      solution:
        'Asegúrate de tener datos suficientes para generar el reporte. Intenta recargar la página y generar el reporte nuevamente.',
      status: 'open',
    },
    {
      id: 4,
      ...
      severity: 'medium',
      solution:
        'Verifica tu conexión a internet. Limpia el caché del navegador. Si el problema persiste, contacta al soporte.',
      status: 'resolved',
    },
  ];
            ...
            {supportChannels.map((channel, index) => (
              <Card key={index} className={`border ${channel.borderColor}`}>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button className="w-full bg-red-500 hover:bg-red-600">Contactar</Button>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">
                  Todos los sistemas están funcionando correctamente. No hay incidentes reportados
                  en este momento.
                </p>
              </div>
            </CardContent>
