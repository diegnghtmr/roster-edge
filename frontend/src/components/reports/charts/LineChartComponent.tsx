    ...
    <ResponsiveContainer width="100%" height={height}>
      ...
      >
        ...
        <YAxis
          ...
          domain={[0, 'auto']}
        />
        <Tooltip content={<CustomTooltip />} cursor={{ stroke: REPORT_COLORS.neutral.gray300, strokeWidth: 2 }} />
        <Legend
          wrapperStyle={{
            paddingTop: '20px',
            fontSize: '14px'
        ...
        {lines.map((line) => (
          <Line
            ...
            activeDot={{ r: 7, strokeWidth: 2, fill: line.color, stroke: REPORT_COLORS.neutral.white }}
          />
        ))}
      </LineChart>
    </ResponsiveContainer>
