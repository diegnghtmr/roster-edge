...
-- Insert sample users
INSERT OR IGNORE INTO users (username, email, full_name, role, status) VALUES
...
-- Insert sample teams
INSERT OR IGNORE INTO teams (name, sport, description, founded_year) VALUES
...
INSERT OR IGNORE INTO players (first_name, last_name, jersey_number, position, date_of_birth, nationality, team_id) VALUES
...
INSERT OR IGNORE INTO matches (home_team_id, away_team_id, match_date, home_score, away_score, status, venue) VALUES
