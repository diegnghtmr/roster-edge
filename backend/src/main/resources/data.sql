...
INSERT INTO "Event" (season_id, venue_id, name, description, date, created_at, updated_at, active) VALUES
    ...
    (1, 1, 'Aguilas First Division vs Aguilas Youth Squad', 'League match against Deportivo Cali', '2024-01-20', NOW(), NOW(), TRUE),
    ...
    (1, 1, 'Aguilas First Division vs Aguilas Youth Squad (Charity)', 'Exhibition match in benefit of the academy', '2099-05-15', NOW(), NOW(), TRUE),
    (4, 2, 'Condor Valle A vs Toro Norte Elite', 'Semi-final leg for Condor Valle campaign', '2025-09-25', NOW(), NOW(), TRUE),
    (4, 2, 'Condor Valle A vs Aguilas First Division', 'Season finale appearance for Condor Valle', '2025-11-05', NOW(), NOW(), TRUE),
    (5, 3, 'Toro Norte Elite vs Toro Norte Femenino', 'Opening fixture for Toro Norte', '2024-03-12', NOW(), NOW(), TRUE),
    (1, 1, 'Aguilas First Division vs Condor Valle A', 'Second league fixture', '2024-02-03', NOW(), NOW(), TRUE),
    (1, 1, 'Condor Valle A vs Aguilas First Division', 'Third league fixture', '2024-02-17', NOW(), NOW(), TRUE),
    (1, 1, 'Toro Norte Elite vs Aguilas First Division', 'Fourth league fixture', '2024-03-02', NOW(), NOW(), TRUE),
    (1, 1, 'Pumas Caribe Primera vs Leones Elite', 'Fifth league fixture', '2024-03-16', NOW(), NOW(), TRUE),
    (1, 1, 'Leones Elite vs Tiburones Pacífico A', 'Sixth league fixture', '2024-03-30', NOW(), NOW(), TRUE),
    (3, 2, 'Condor Valle A vs Toro Norte Elite', 'Second matchday Valle', '2024-03-05', NOW(), NOW(), TRUE),
    (3, 2, 'Condor Valle A vs Pumas Caribe Primera', 'Third matchday Valle', '2024-03-19', NOW(), NOW(), TRUE),
    (3, 2, 'Condor Valle A vs Aguilas First Division', 'Fourth matchday Valle', '2024-04-02', NOW(), NOW(), TRUE),
    (5, 3, 'Toro Norte Elite vs Toro Norte Femenino', 'Second fixture Apertura', '2024-02-05', NOW(), NOW(), TRUE),
    (5, 3, 'Toro Norte Elite vs Aguilas First Division', 'Third fixture Apertura', '2024-02-19', NOW(), NOW(), TRUE),
    (5, 3, 'Pumas Caribe Primera vs Leones Elite', 'Fourth fixture Apertura', '2024-03-05', NOW(), NOW(), TRUE),
    (6, 3, 'Leones Elite vs Tiburones Pacífico A', 'First match Clausura', '2024-07-08', NOW(), NOW(), TRUE),
    (6, 3, 'Tiburones Pacífico A vs Toro Norte Elite', 'Second match Clausura', '2024-07-22', NOW(), NOW(), TRUE),
    ...
    (9, 5, 'Jaguares Paulistas A vs Jaguares Juvenil', 'Classic mountain derby', '2024-03-10', NOW(), NOW(), TRUE),
    (9, 5, 'Jaguares Paulistas A vs Jaguares Juvenil', 'Second mountain fixture', '2024-03-24', NOW(), NOW(), TRUE),
    (11, 6, 'Aztecas MX Primera vs Aztecas MX Femenino', 'Pacific Cup opener', '2024-04-15', NOW(), NOW(), TRUE),
    (11, 6, 'Aztecas MX Primera vs Aztecas MX Femenino', 'Classic Pacific derby', '2024-04-29', NOW(), NOW(), TRUE),
    (13, 7, 'Leones Elite vs Tiburones Pacífico A', 'First Argentine fixture', '2024-03-05', NOW(), NOW(), TRUE),
    (13, 7, 'Tiburones Pacífico A vs Toro Norte Elite', 'Second Argentine fixture', '2024-03-19', NOW(), NOW(), TRUE),
    (14, 8, 'Leones Elite vs Tiburones Pacífico A', 'Classic Rosario derby', '2024-03-24', NOW(), NOW(), TRUE),
    (15, 9, 'Tiburones Pacífico A vs Aztecas MX Primera', 'Historic Spanish derby', '2024-10-15', NOW(), NOW(), TRUE),
    (16, 10, 'Tiburones Pacífico A vs Aguilas First Division', 'Catalan derby', '2024-10-22', NOW(), NOW(), TRUE),
    (17, 11, 'Aguilas Femenino vs Pumas Femenino', 'First Brazilian fixture', '2024-05-15', NOW(), NOW(), TRUE),
    (17, 11, 'Condor Valle Juvenil vs Leones Reserva', 'Second Brazilian fixture', '2024-05-29', NOW(), NOW(), TRUE),
    (19, 12, 'Pumas Caribe Sub-20 vs Aztecas MX Sub-17', 'First Liga MX match', '2024-07-22', NOW(), NOW(), TRUE),
    (19, 12, 'Tiburones Femenino vs Madrid Legends Femenino', 'Second Liga MX match', '2024-08-05', NOW(), NOW(), TRUE),
    (19, 12, 'Dragones BA Primera vs Halcones Rosario A', 'Mexican national classic', '2024-08-19', NOW(), NOW(), TRUE),
    (20, 12, 'Madrid Legends Primera vs Barcelona Unidos A', 'First Clausura match', '2025-01-17', NOW(), NOW(), TRUE),
    (10, 5, 'Barcelona Unidos Juvenil vs Dragones BA Juvenil', 'Late-season clash at Mountain Fortress', '2025-10-04', NOW(), NOW(), TRUE),
    (12, 6, 'Halcones Femenino vs Barcelona Unidos Femenino', 'Decisive Pacific Cup fixture', '2025-10-18', NOW(), NOW(), TRUE),
    (10, 5, 'Barcelona Unidos Juvenil vs Dragones BA Juvenil', 'Penultimate Mountain League duel', '2025-11-02', NOW(), NOW(), TRUE),
    (12, 6, 'Halcones Femenino vs Barcelona Unidos Femenino', 'Pacific Cup semifinal push', '2025-11-16', NOW(), NOW(), TRUE),
    (12, 6, 'Halcones Femenino vs Barcelona Unidos Femenino', 'Final group stage night in Pacific Cup', '2025-12-07', NOW(), NOW(), TRUE),
    (2, 1, 'Aguilas Femenino vs Pumas Femenino', 'Key fixture featuring Aguilas Femenino vs Pumas Femenino', '2025-10-09', NOW(), NOW(), TRUE),
    (4, 2, 'Condor Valle Juvenil vs Leones Reserva', 'Condor Valle Juvenil hosts Leones Reserva in decisive clash', '2025-10-12', NOW(), NOW(), TRUE),
    (8, 4, 'Pumas Caribe Sub-20 vs Aztecas MX Sub-17', 'Pumas Caribe Sub-20 fight for top spot versus Aztecas Sub-17', '2025-10-26', NOW(), NOW(), TRUE),
    (12, 6, 'Halcones Femenino vs Barcelona Unidos Femenino', 'Tiburones Femenino defend home waters against Madrid Legends', '2025-11-09', NOW(), NOW(), TRUE),
    (21, 7, 'Dragones BA Primera vs Halcones Rosario A', 'Dragones BA Primera duel Halcones Rosario A for playoff hopes', '2025-11-23', NOW(), NOW(), TRUE),
    (23, 9, 'Madrid Legends Primera vs Barcelona Unidos A', 'Madrid Legends receive Barcelona Unidos in penultimate round', '2025-12-01', NOW(), NOW(), TRUE),
    (24, 10, 'Barcelona Unidos Juvenil vs Dragones BA Juvenil', 'Barcelona Unidos Juvenil face Dragones Juvenil in showcase', '2025-12-05', NOW(), NOW(), TRUE),
    (22, 8, 'Halcones Femenino vs Barcelona Unidos Femenino', 'Halcones Femenino battle Barcelona Unidos Femenino for the crown', '2025-12-12', NOW(), NOW(), TRUE)
ON CONFLICT DO NOTHING;
